This is a preliminary (but working!) version of the tidal code for the Europa paper.
...
Corresponding author for the current version and maintenace:L Laurent Pou (laurent.pou@jpl.nasa.gov)
